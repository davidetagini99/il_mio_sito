...
CREATE TABLE `project_votes` (
  ...
  PRIMARY KEY (`vote_id`),
  KEY `fk_project_votes_project_id` (`project_id`),
  CONSTRAINT `fk_project_votes_project_id` FOREIGN KEY (`project_id`) REFERENCES `projectsbox` (`project_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `project_votes` VALUES (1,2,'::1',4,'2024-02-28 09:38:25'),(2,2,'::1',5,'2024-02-28 13:09:06');
